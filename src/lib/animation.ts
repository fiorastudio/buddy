...
const SPECIES_OVERRIDES: Partial<Record<string, Partial<AnimationProfile> & { dwellMs?: number }>> = {
  ...
  'Penguin':      {
    dwellMs: 400,
    idle: [{ frame: 1 }, { frame: 1 }, { frame: 0 }, { frame: 3 }, { frame: 3 }, { frame: 0 }, { frame: 4 }],
    happy: [{ frame: 1 }, { frame: 1 }, { frame: 0 }, { frame: 3 }, { frame: 3 }, { frame: 0 }, { frame: 1 }, { frame: 3 }, { frame: 4 }],
    content: [{ frame: 1 }, { frame: 0 }, { frame: 3 }, { frame: 0 }],
    reactionExcited: [{ frame: 1 }, { frame: 1 }, { frame: 3 }, { frame: 3 }, { frame: 1 }, { frame: 3 }],
    reactionImpressed: [{ frame: 1 }, { frame: 0 }, { frame: 3 }, { frame: 0 }, { frame: 4 }],
  },
  'Rabbit':       { dwellMs: 400 },
};
